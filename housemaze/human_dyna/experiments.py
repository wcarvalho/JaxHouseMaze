...
def basic_make_exp_block(
    ...
    def make_int(i): return jnp.array(i, dtype=jnp.int32)
    ...
    maze2idx = {maze_name: idx for idx,
                maze_name in enumerate(all_mazes+[pretrain_level])}
    if pretrain_level:
...
def exp1(config, analysis_eval: bool = False):
    ...
    if analysis_eval:
        eval_mazes = ['maze3_open2', 'maze3_onpath_shortcut_r',
                      'maze3_offpath_shortcut_r', 'maze5', 'maze6_flipped_offtask']
    else:
